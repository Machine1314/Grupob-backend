...
public class ClienteQuery_QV_DN57_WPJ49 implements IGridRowDeleting {
	/**
	 * Instancia de Logger
	 */
	private static final ILogger logger = LogFactory.getLogger(ClienteQuery_QV_DN57_WPJ49.class);

	@Reference(bind="setBliEliminarCliente",
			unbind="unsetBliEliminarCliente",
			cardinality=ReferenceCardinality.MANDATORY_UNARY,
			target="(bli.id=BLI1788_bli_eliminarcliente)")
	private IBLIExecutor bliEliminarCliente;
	
	public void setBliEliminarCliente(IBLIExecutor bliEliminarCliente) {
		this.bliEliminarCliente = bliEliminarCliente;
	}
	
	public void unsetBliEliminarCliente(IBLIExecutor bliEliminarCliente) {
